package com.vcredit.wxapi.wxshop;
...
import com.vcredit.wxapi.coupon.location.model.BaseInfo;
import com.vcredit.wxapi.wxshop.model.Business;
import com.vcredit.wxapi.wxshop.model.BusinessReq;
import com.vcredit.wxapi.wxshop.model.PoiId;
import com.vcredit.wxapi.wxshop.model.ShopRtnInfo;
...
public class JwShopAPI {
	// 创建门店
	private static String create_shop_url = "http://wxapi.weixin.qq.com/cgi-bin/poi/addpoi?access_token=TOKEN";
	// 查询门店信息
	private static String get_shop_url = "http://wxapi.weixin.qq.com/cgi-bin/poi/getpoi?access_token=TOKEN";
	// 查询门店列表
	private static String search_shop_url = "https://wxapi.weixin.qq.com/cgi-bin/poi/getpoilist?access_token=TOKEN";
	// 删除门店
	private static String del_shop_url = "https://wxapi.weixin.qq.com/cgi-bin/poi/delpoi?access_token=TOKEN";
	// 上传图片
	private static String upload_img_shop_url = "https://wxapi.weixin.qq.com/cgi-bin/media/uploadimg?access_token=ACCESS_TOKEN";
	// 修改门店服务信息
	private static String updatebystatus_shop_url = "https://wxapi.weixin.qq.com/cgi-bin/poi/updatepoi?access_token=TOKEN";
	// 门店类目表
	private static String shop_category_url = "http://wxapi.weixin.qq.com/cgi-bin/api_getwxcategory?access_token=TOKEN";

package com.vcredit.wxapi.wxsendmsg;
...
import com.vcredit.wxapi.core.req.model.user.Group;
import com.vcredit.wxapi.core.util.WeiXinReqUtil;
import com.vcredit.wxapi.wxbase.wxmedia.model.WxArticlesRequest;
import com.vcredit.wxapi.wxsendmsg.model.*;
import com.vcredit.wxapi.wxuser.user.model.Wxuser;
...
public class JwSendMessageAPI {
	...
	// 消息预览URL
	private static String message_preview_url = "https://wxapi.weixin.qq.com/cgi-bin/message/mass/preview?access_token=ACCESS_TOKEN";
	// 上传媒体资源URL
	private static String upload_media_url = "http://file.wxapi.weixin.qq.com/cgi-bin/media/upload?access_token=ACCESS_TOKEN&type=TYPE";
	// 上传图文素材资源URL
	private static String upload_article_url = "https://wxapi.weixin.qq.com/cgi-bin/media/uploadnews?access_token=ACCESS_TOKEN";
	// 根据分组进行群发URL
	private static String message_group_url = "https://wxapi.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=ACCESS_TOKEN";
	// 根据OpenID列表群发URL
	private static String message_openid_url = "https://wxapi.weixin.qq.com/cgi-bin/message/mass/send?access_token=ACCESS_TOKEN";
	// 删除群发URL
	private static String message_delete_url = "https://wxapi.weixin.qq.com/cgi-bin/message/mass/delete?access_token=ACCESS_TOKEN";
	// 查询群发消息发送状态URL
	private static String message_get_url = "https://wxapi.weixin.qq.com/cgi-bin/message/mass/get?access_token=ACCESS_TOKEN";

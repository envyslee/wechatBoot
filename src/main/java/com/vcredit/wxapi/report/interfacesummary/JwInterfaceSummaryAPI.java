package com.vcredit.wxapi.report.interfacesummary;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.AccessToken;
import com.vcredit.wxapi.core.common.JSONHelper;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.core.req.model.interfacesummary.InterfaceSummaryParam;
import com.vcredit.wxapi.report.interfacesummary.model.InterfaceSummary;
import com.vcredit.wxapi.report.interfacesummary.model.InterfaceSummaryHour;
...
public class JwInterfaceSummaryAPI {
	//获取接口分析数据 
	private static String getinterfacesummary_url = "https://wxapi.weixin.qq.com/datacube/getinterfacesummary?access_token=ACCESS_TOKEN";
	//获取接口分析分时数据
	private static String getinterfacesummaryhour_url = "https://wxapi.weixin.qq.com/datacube/getinterfacesummaryhour?access_token=ACCESS_TOKEN";

package com.vcredit.wxapi.report.datacube;
...
import com.vcredit.wxapi.core.req.model.dataCube.*;
import com.vcredit.wxapi.report.datacube.model.*;
...
public class JwDataCubeAPI {
	...
	//获取消息发送概况数据 
	private static String GETUPSTREAMMSG_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsg?access_token=ACCESS_TOKEN";
	//获取消息分送分时数据
	private static String GETUPSTREAMMSGHOUR_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsghour?access_token=ACCESS_TOKEN";
	//获取消息发送周数据
	private static String GETUPSTREAMMSGWEEK_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsgweek?access_token=ACCESS_TOKEN";
	//获取消息发送月数据
	private static String GETUPSTREAMMSGMONTH_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsgmonth?access_token=ACCESS_TOKEN";
	//获取消息发送分布数据
	private static String GETUPSTREAMMSGDIST_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsgdist?access_token=ACCESS_TOKEN";
	//获取消息发送分布周数据
	private static String GETUPSTREAMMSGDISTWEEK_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsgdistweek?access_token=ACCESS_TOKEN";
	//获取消息发送分布月数据
	private static String GETUPSTREAMMSGDISTMONTH_URL = "https://wxapi.weixin.qq.com/datacube/getupstreammsgdistmonth?access_token=ACCESS_TOKEN";

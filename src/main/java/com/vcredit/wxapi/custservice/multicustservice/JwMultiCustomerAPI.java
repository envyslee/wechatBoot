package com.vcredit.wxapi.custservice.multicustservice;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.JSONHelper;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.custservice.multicustservice.model.ChatRecord;
import com.vcredit.wxapi.custservice.multicustservice.model.CustService;
...
public class JwMultiCustomerAPI {
    ...
    // 获取在线客服接待信息
    private static String GET_ONLINE_CUSTSEVICE_URL = "https://wxapi.weixin.qq.com/cgi-bin/customservice/getonlinekflist?access_token=ACCESS_TOKEN";
    
    //获取客服记录列表
    private static String GET_CUSTSEVICE_ROCORD_LIST_URL = "https://wxapi.weixin.qq.com/cgi-bin/customservice/getrecord?access_token=ACCESS_TOKEN";

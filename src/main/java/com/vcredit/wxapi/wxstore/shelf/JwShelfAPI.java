package com.vcredit.wxapi.wxstore.shelf;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.JSONHelper;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.wxstore.shelf.model.Shelf;
import com.vcredit.wxapi.wxstore.shelf.model.ShelfRInfo;
import com.vcredit.wxapi.wxstore.shelf.model.ShelfRtnInfo;
...
public class JwShelfAPI {
	...
	// 增加货架
	private static String create_shelf_url = "https://wxapi.weixin.qq.com/merchant/shelf/add?access_token=ACCESS_TOKEN";
	
	// 根据货架ID获取货架信息
	private static String getid_shelf_url = "https://wxapi.weixin.qq.com/merchant/shelf/getbyid?access_token=ACCESS_TOKEN";
	
	// 获取所有货架
	private static String getall_shelf_url = "https://wxapi.weixin.qq.com/merchant/shelf/getall?access_token=ACCESS_TOKEN";
	
	// 修改货架
	private static String update_shelf_url = "https://wxapi.weixin.qq.com/merchant/shelf/mod?access_token=ACCESS_TOKEN";
	
	// 删除货架
	private static String del_shelf_url = "https://wxapi.weixin.qq.com/merchant/shelf/del?access_token=ACCESS_TOKEN";

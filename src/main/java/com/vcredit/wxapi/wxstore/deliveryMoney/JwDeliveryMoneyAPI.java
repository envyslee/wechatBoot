package com.vcredit.wxapi.wxstore.deliveryMoney;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.JSONHelper;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.wxstore.deliveryMoney.model.DeliveryMoney;
import com.vcredit.wxapi.wxstore.deliveryMoney.model.DeliveryMoneyRtnInfo;
...
public class JwDeliveryMoneyAPI {
	// 增加邮费模板
	private static String create_postage_url = "https://wxapi.weixin.qq.com/merchant/express/add?access_token=ACCESS_TOKEN";
	// 修改邮费模板
	private static String update_postage_url = "https://wxapi.weixin.qq.com/merchant/express/update?access_token=ACCESS_TOKEN";
	// 获取指定ID的邮费模板
	private static String get_postage_url = "https://wxapi.weixin.qq.com/merchant/express/getbyid?access_token=ACCESS_TOKEN";
	// 删除邮费模板
	private static String del_postage_url = "https://wxapi.weixin.qq.com/merchant/express/del?access_token=ACCESS_TOKEN";
	// 获取所有邮费模板
	private static String getall_postage_url = "https://wxapi.weixin.qq.com/merchant/express/getall?access_token=ACCESS_TOKEN";

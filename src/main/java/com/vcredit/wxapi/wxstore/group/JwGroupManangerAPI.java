package com.vcredit.wxapi.wxstore.group;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.JSONHelper;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.wxstore.group.model.Group;
import com.vcredit.wxapi.wxstore.group.model.GroupDetailInfo;
import com.vcredit.wxapi.wxstore.group.model.GroupProductInfo;
import com.vcredit.wxapi.wxstore.group.model.GroupRtnInfo;
...
public class JwGroupManangerAPI {
	// 增加分组
	private static String create_group_url = "https://wxapi.weixin.qq.com/merchant/group/add?access_token=ACCESS_TOKEN";
	// 修改分组属性
	private static String update_group_url = "https://wxapi.weixin.qq.com/merchant/group/propertymod?access_token=ACCESS_TOKEN";
	// 根据分组ID获取分组信息
	private static String getid_group_url = "https://wxapi.weixin.qq.com/merchant/group/getbyid?access_token=ACCESS_TOKEN";
	// 删除分组
	private static String del_group_url = "https://wxapi.weixin.qq.com/merchant/group/del?access_token=ACCESS_TOKEN";
	// 获取所有分组
	private static String getall_group_url = "https://wxapi.weixin.qq.com/merchant/group/getall?access_token=ACCESS_TOKEN";
	// 修改分组商品
	private static String update_productmod_url = "https://wxapi.weixin.qq.com/merchant/group/productmod?access_token=ACCESS_TOKEN";

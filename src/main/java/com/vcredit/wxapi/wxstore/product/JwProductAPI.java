package com.vcredit.wxapi.wxstore.product;
...
import com.vcredit.wxapi.core.common.util.WeixinUtil;
import com.vcredit.wxapi.wxstore.product.model.*;
...
public class JwProductAPI {
	// 增加商品
	private static String create_commodity_url = "https://wxapi.weixin.qq.com/merchant/create?access_token=${ACCESS_TOKEN}";
	// 修改商品
	private static String update_commodity_url = "https://wxapi.weixin.qq.com/merchant/update?access_token=ACCESS_TOKEN";
	// 查询商品
	private static String get_commodity_url = "https://wxapi.weixin.qq.com/merchant/get?access_token=ACCESS_TOKEN";
	// 删除商品
	private static String del_commodity_url = "https://wxapi.weixin.qq.com/merchant/del?access_token=ACCESS_TOKEN";
	// 上传图片
	private static String upload_img_commodity_url = "https://wxapi.weixin.qq.com/merchant/common/upload_img?access_token=ACCESS_TOKEN&filename=IMG_NAME";
	// 获取指定状态商品
	private static String getbystatus_commodity_url = "https://wxapi.weixin.qq.com/merchant/getbystatus?access_token=ACCESS_TOKEN";
	// 商品上下架
	private static String modproductstatus_commodity_url = "https://wxapi.weixin.qq.com/merchant/modproductstatus?access_token=ACCESS_TOKEN";
	// 指定分类的所有子分类
	private static String getsub_commodity_url = "https://wxapi.weixin.qq.com/merchant/category/getsub?access_token=ACCESS_TOKEN";
	// 指定子分类的所有SKU
	private static String getsku_commodity_url = "https://wxapi.weixin.qq.com/merchant/category/getsku?access_token=ACCESS_TOKEN";
	// 指定分类的所有属性
	private static String getproperty_commodity_url = "https://wxapi.weixin.qq.com/merchant/category/getproperty?access_token=ACCESS_TOKEN";

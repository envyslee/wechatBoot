package com.vcredit.wxapi.coupon.manage;

import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.coupon.manage.model.*;
...
public class JwCardManageAPI {
	// 删除卡券
	private static final String del_card_url = "https://wxapi.weixin.qq.com/card/delete?access_token=ACCESS_TOKEN";
	// 查询卡券
	private static final String get_card_url = "https://wxapi.weixin.qq.com/card/code/get?access_token=ACCESS_TOKEN";
	// 批量查询卡列表
	private static final String batchget_card_url = "https://wxapi.weixin.qq.com/card/batchget?access_token=ACCESS_TOKEN";
	// 查询卡券详情
	private static final String get_card_detail_url = "https://wxapi.weixin.qq.com/card/get?access_token=ACCESS_TOKEN";
	//更改code
	private static final String update_code_url = "https://wxapi.weixin.qq.com/card/code/update?access_token=ACCESS_TOKEN";
	//设置卡券失效
	private static final String unavailable_code_url = "https://wxapi.weixin.qq.com/card/code/unavailable?access_token=ACCESS_TOKEN";
	//更改卡券信息
	private static final String update_card_url = "https://wxapi.weixin.qq.com/card/update?access_token=ACCESS_TOKEN";
	//更改库存
	private static final String modifystock_card_url = "https://wxapi.weixin.qq.com/card/modifystock?access_token=ACCESS_TOKEN";

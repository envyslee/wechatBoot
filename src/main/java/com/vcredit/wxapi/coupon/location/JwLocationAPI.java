...
public class JwLocationAPI {
	...
	*/// 批量导入门店信息
	private static String batchadd_location_url = "https://wxapi.weixin.qq.com/card/location/batchadd?access_token=ACCESS_TOKEN";
	// 拉取门店列表
	private static String batchget_location_url = "https://wxapi.weixin.qq.com/card/location/batchget?access_token=ACCESS_TOKEN";
	// 获取颜色列表
	private static String getcolors_location_url = "https://wxapi.weixin.qq.com/card/getcolors?access_token=ACCESS_TOKEN";
	// CreateCard 创建卡
	private static String add_card_url = "https://wxapi.weixin.qq.com/card/create?access_token=ACCESS_TOKEN";

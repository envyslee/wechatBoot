package com.vcredit.wxapi.coupon.consume;

import net.sf.json.JSONObject;
import com.vcredit.wxapi.core.common.WxstoreUtils;
import com.vcredit.wxapi.coupon.consume.model.ConsumeRtnInfo;
import com.vcredit.wxapi.coupon.consume.model.EncryptRtnInfo;
...
public class JwCardConsumeAPI {
	// 消耗code 即核销一张卡券
	private static final String consume_code_url = "https://wxapi.weixin.qq.com/card/code/consume?access_token=ACCESS_TOKEN";
	// 解码code
	private static final String decrypt_code_url = "https://wxapi.weixin.qq.com/card/code/decrypt?access_token=ACCESS_TOKEN";

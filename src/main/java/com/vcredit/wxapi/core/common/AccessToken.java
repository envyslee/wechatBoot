package com.vcredit.wxapi.core.common;
...
public class AccessToken {
	...
	public String getNewAccessToken() {
		String token = null;
		String requestUrl = "https://wxapi.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET".replace("APPID", this.getAppid()).replace("APPSECRET", this.getAppscret());

package com.vcredit.wxapi.core.util;
...
public class WeiXinReqUtil {
	...
	public static void initReqConfig(String configName) throws JDOMException, IOException{
		...
		for(Element mapping :lstMapping){
			...
			String mappingHandler ="com.vcredit.wxapi.core.handler.impl.WeixinReqDefaultHandler";
	...
	public static String getFileContentType(String fileSuffix) {
		if (file_content_type == null) {
			...
			InputStream in = WeiXinReqService.class.getClassLoader().getResourceAsStream("/config/fie-content-type.properties");
			try {
